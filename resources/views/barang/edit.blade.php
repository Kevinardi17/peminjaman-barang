    ...
    <div class="bg-white rounded-2xl shadow-sm border p-5 max-w-2xl">
        <form action="{{ route('barang.update', $barang) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div>
                ...
                <input type="number" id="input-stok" name="stok" value="{{ old('stok', $barang->stok) }}" class="w-full border rounded-lg px-3 py-2" min="0">
            ...
            <div>
                ...
                <input type="hidden" id="input-kondisi" name="kondisi" value="{{ old('kondisi', $barang->kondisi) }}">
